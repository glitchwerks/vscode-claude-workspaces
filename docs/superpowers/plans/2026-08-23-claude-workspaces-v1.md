...
- [ ] Register the seven approved commands: `newSession`, `newInFolder`, `closeSession`, `restartFresh`, `previousSession`, `nextSession`, and `configureWorkspace`. Commands must return without side effects when the saved-workspace context is false (`docs/superpowers/specs/2026-08-23-claude-workspaces.md:L131-L149`, `L216-L239`).
